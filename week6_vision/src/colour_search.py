...
# DEV:
# Tune the HSV ranges for light blue & red
...
class colour_search(object):
    ...
    def camera_callback(self, img_data):
        ...
        for color in ranges:
            lower = ranges[color]['lower']
            upper = ranges[color]['upper']
            ...
            if self.m00 > self.m00_min:
                cv2.circle(crop_img, (int(self.cy), 200), 10, (255, 255, 255), 2)
                cv2.putText(crop_img, color, (int(self.cy), 200), cv2.FONT_HERSHEY_SIMPLEX, 2, (255, 255, 255), 2, cv2.LINE_AA)
                break
